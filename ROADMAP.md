...
- Documentation classifying current build-time image service and future adapter/CDN boundaries after auditing Astro's image service docs.
...
- Decide whether provider image CDNs belong in deployment adapters, image services, or userland URL helpers.
